...
{
    public static class IntermediatePrecision
    {
        private static Application _app;

        private const string TempDirectoryName = "ABD_TempFiles";

        public static string UpdateIntermediatePrecisionSheet(
            string sourcePath,
            // --- General ---
            string strcmbProtocolType, string strcmbProductType, string strcmbTestType)
        {
            ...
            try
            {
                returnPath = UpdateIntermediatePrecisionSheet2(
                    sourcePath,
                    // --- General ---
            ...
            {
                Logger.LogMessage("An error occurred in the call to IntermediatePrecision.UpdateIntermediatePrecisionSheet." +
        ...
        private static string UpdateIntermediatePrecisionSheet2(
            string sourcePath,
            // --- General ---
            string strcmbProtocolType, string strcmbProductType, string strcmbTestType
        )
        {
            ...
            {
                Logger.LogMessage("Error in call to IntermediatePrecision.UpdateIntermediatePrecisionSheet2. Invalid source file path specified.", Level.Error);
                return "";
            }

            string savePath = WorksheetUtilities.CopyWorkbook(sourcePath, TempDirectoryName, "Intermediate Precision Results.xls");
