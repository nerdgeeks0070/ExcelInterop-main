...
namespace Spreadsheet.Handler
{
    public static class Reproducibility
    {
        ...
        public static string UpdateReproducibilitySheet(
            string sourcePath,
            // --- General ---
            string strcmbProtocolType, string strcmbProductType, string strcmbTestType)
        {
            ...
            try
            {
                returnPath = UpdateReproducibilitySheet2(
                    sourcePath,
                    // --- General ---
            ...
            {
                Logger.LogMessage("An error occurred in the call to Reproducibility.UpdateReproducibilitySheet." +
        ...
        private static string UpdateReproducibilitySheet2(
            string sourcePath,
            // --- General ---
            string strcmbProtocolType, string strcmbProductType, string strcmbTestType
        )
        {
            ...
            {
                Logger.LogMessage("Error in call to Reproducibility.UpdateReproducibilitySheet2. Invalid source file path specified.", Level.Error);
                return "";
            }

            string savePath = WorksheetUtilities.CopyWorkbook(sourcePath, TempDirectoryName, "Reproducibility Results.xls");
