...
namespace Spreadsheet.Handler
{
    public static class Accuracy
    {
        ...
        private static string UpdateAccuracySheet2(string sourcePath, IList<string> percentConcList, int numReps, string targetConc, string units)
        {
            ...
            if (sheet != null)
            {
                ...
                if (percentConcList.Count > DefaultNumConcs)
                {
                    ...
                    //07-26: Removed the hidden section of the result spreadsheet, commented all code related to those named ranges
                ...
                //WorksheetUtilities.DeleteNamedRangeRows(sheet, "CofidenceInterval");
                //WorksheetUtilities.DeleteNamedRange(sheet, "CofidenceInterval");
                //WorksheetUtilities.DeleteNamedRangeRows(sheet, "Results");
                //WorksheetUtilities.DeleteNamedRange(sheet, "Results");

                // Set conc values into Raw Data Table & set the borders
                for (int i = 1; i <= percentConcList.Count; i++)
                {
                    WorksheetUtilities.SetNamedRangeValue(sheet, "RawDataAndCalcsSet" + i, percentConcList[i - 1], 1, 3);
        ...
        private static void FixRawDataFormulas(_Worksheet sheet)
        {
            ...
            for (int i = DefaultNumConcs; i >= 1; i--)
            {
                ...
                try
                {
                    ...
                    WorksheetUtilities.ReleaseComObject(namedRange);
        ...
        private static void UpdateConfidenceIntervalFormulas(_Worksheet sheet)
        {
            ...
            for (int i = 2; i <= numRowsToUpdate; i++)
            {
                try
                {
                    ...
                    string newConcFormula = concFormula.Replace("C" + startRawRowNum, "C" + newRowNum);
                    ...
                    WorksheetUtilities.ReleaseComObject(rangeConc);
                    ...
                    WorksheetUtilities.ReleaseComObject(rangeLower);
                    ...
                    WorksheetUtilities.ReleaseComObject(rangeUpper);
                    WorksheetUtilities.ReleaseComObject(rangeRow);
                }
                catch
                {
                    continue;
            ...
            CleanUp_UpdateConfidenceIntervalFormulas:
            {
                try
                {
                    WorksheetUtilities.ReleaseComObject(objConfNamedRange);
                    WorksheetUtilities.ReleaseComObject(confRange);
                    WorksheetUtilities.ReleaseComObject(confNamedRange);
                    WorksheetUtilities.ReleaseComObject(objRawDataSet1NamedRange);
                    WorksheetUtilities.ReleaseComObject(rawDataSet1NamedRange);
                    WorksheetUtilities.ReleaseComObject(rawDataSet1Range);
        ...
        private static void UpdateResultsFormulas(_Worksheet sheet)
        {
            ...
            //// Get the range by name for the FIRST range in the raw data series
            ////07-26: Commented the lines that refer to the hidden sections of the spreadsheet
            ...
            //int numRowsToUpdate = rawDataSet1Range.Rows.Count - 1;
            ...
            //        while (WorksheetUtilities.ReleaseComObject(rangeConc) >= 0) { }
            ...
            //        while (WorksheetUtilities.ReleaseComObject(rangeMean) >= 0) { }
            ...
            //        while (WorksheetUtilities.ReleaseComObject(rangeLowerUpper) >= 0) { }
            //        while (WorksheetUtilities.ReleaseComObject(rangeRow) >= 0) { }
            //    }
            //    catch
            //    {
            //        continue;
            ...
            //    try
            //{
            //    WorksheetUtilities.ReleaseComObject(objResultsNamedRange);
            //    WorksheetUtilities.ReleaseComObject(resultsNamedRange);
            //    WorksheetUtilities.ReleaseComObject(resultsRange);
            //    WorksheetUtilities.ReleaseComObject(objRawDataSet1NamedRange);
            //    WorksheetUtilities.ReleaseComObject(rawDataSet1NamedRange);
            //    WorksheetUtilities.ReleaseComObject(rawDataSet1Range);
            //    WorksheetUtilities.ReleaseComObject(objConfTableNamedRange);
            //    WorksheetUtilities.ReleaseComObject(confTableNamedRange);
            //    WorksheetUtilities.ReleaseComObject(confTableRange);
            //    WorksheetUtilities.ReleaseComObject(rangeRow);
            //    WorksheetUtilities.ReleaseComObject(rangeConc);
            //    WorksheetUtilities.ReleaseComObject(rangeMean);
            //    WorksheetUtilities.ReleaseComObject(rangeLowerUpper);
            //}
            //    catch
            //    {
            //        return;
